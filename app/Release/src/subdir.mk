...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"C:\MinGW\include" -I"/mingw64/lib" -I/usr/local/include -I"../../lib/src" -O3 -Wall -c -fmessage-length=0 --std=gnu++11  -Wl,--stack,4194304 -fopenmp -Wa,-mbig-obj -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
